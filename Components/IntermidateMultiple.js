...
import IntermidateQuiz from '../Components/IntermidateQuiz';
...
class IntermidateMultiple extends Component {
  state = {
    quizFinish: false,
    score: 0,
  };
    ...
    return (
      <View style={{flex: 1}}>
        ...
        {this.state.quizFinish ? (
          ...
          <IntermidateQuiz quizFinish={score => this._quizFinish(score)} />
        )}
      </View>
    );
  }
...
export default IntermidateMultiple;
